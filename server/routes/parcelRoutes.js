...
const { UserController, ParcelController } = controllers;
...
parcelRouter
  ...
  .post(
    ParcelValidator.validateCreateParcel(),
...
parcelRouter.get(
  "/api/v1/users/:userId(\\d+)/parcels/:parcelId(\\d+)",
  UserController.authenticateUser(),
  ParcelController.getParcel()
);

parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/cancel",
  UserController.authenticateUser(),
  ParcelController.updateParcel("cancel")
);

parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/presentLocation",
  UserController.authenticateUser(),
  UserController.authorizeUser(),
...
parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/status",
  UserController.authenticateUser(),
  UserController.authorizeUser(),
...
parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/destination",
  UserController.authenticateUser(),
...
parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/editParcel",
  UserController.authenticateUser(),
...
parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/editPickup",
  UserController.authenticateUser(),
...
parcelRouter.put(
  "/api/v1/parcels/:parcelId(\\d+)/editReceiver",
  UserController.authenticateUser(),
...
parcelRouter.get(
  "/api/v1/users/:userId(\\d+)/parcels/count",
  UserController.authenticateUser(),
  ParcelController.countOrders()
);

parcelRouter.get("/api/v1/states", ParcelController.getPlaces("States"));

parcelRouter.get(
  "/api/v1/states/:stateId(\\d+)/lgas",
  ParcelController.getPlaces("Local Government Areas")
);

parcelRouter.get(
  "/api/v1/states/:stateId(\\d+)/lgas/:lgaId(\\d+)",
