...
authRouter.get(
  "/api/v1/auth/profileDetails",
  UserController.authenticateUser(),
  UserController.getProfileDetails()
);

authRouter.put(
  "/api/v1/auth/editName",
  UserController.authenticateUser(),
...
authRouter.post("/api/v1/auth/verifyAuth", UserController.checkAuth());
