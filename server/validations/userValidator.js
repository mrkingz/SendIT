...
export default class UserValidator extends Validator {
  ...
  static validateEmail() {
    return (req, res, next) => {
      return this.validate(
        ...
        res,
        next,
        Joi.object().keys(this.getEmailSchema())
      );
    };
  }
  ...
  static getPhoneSchema(obj = {}) {
    ...
    const schema = {
      countryCode: Joi.string()
        ...
        .label(codeLabel)
        .error(errors => this.formatError(errors, codeLabel)),
      [key || "phoneNumber"]: Joi.string()
        ...
        .label(label)
        .error(errors => this.formatError(errors, label))
    };
    if (requestMethod === "POST") {
      ...
      schema.code = Joi.string()
        ...
        .required()
        .label(vCodeLabel)
        .error(errors => this.formatError(errors, vCodeLabel));
    }
    return schema;
  }
  ...
  static getNameSchema() {
    ...
    const name = Joi.string()
      ...
      .regex(exp)
      .lowercase()
      .error(errors => this.formatError(errors));
