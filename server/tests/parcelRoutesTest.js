  ...
  it("It should not create a parcel order if delivery method is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Delivery method is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if pick up Address is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Pickup address is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if destination LGAId is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Destination address is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if destination LGA Id is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Destination L.G.A. Id must be a number"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if destination StateId is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Destination state Id must be a number"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if name of receiver is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Receiver name is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if phone number of receiver is empty", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Receiver phone number is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if delivery method is invalid", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Delivery method must be one of [Fast, Normal]"
        );
        done();
      });
  });
  ...
  it("It should not create a parcel order if phone number is invalid", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(res.statusCode).to.equal(400);
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal("Receiver phone number is inavlid");
        done();
      });
  });
  ...
  it("It should not get all parcels if user is not an admin", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "You do not have the privilege for this operation"
        );
        done();
      });
  });
  ...
  it("It should upDate the destination of a parcel", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Success");
        expect(response.message).to.equal(
          "Parcel destination successfully updated"
        );
        done();
      });
  });
  ...
  it(`It should not update the present location 
    ...
    server
      ...
      .end((err, res) => {
        ...
        expect(res.statusCode).to.equal(400);
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal("Location state Id is required");
        done();
      });
  });
  ...
  it(`It should not upDate the present location 
    ...
    server
      ...
      .end((err, res) => {
        ...
        expect(res.statusCode).to.equal(400);
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal("Location state Id must be a number");
        done();
      });
  });
  ...
  it("It should not update the status of an order if location is not updated", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "No record of present location found, cannot update status to Transiting"
        );
        done();
      });
  });
  ...
  it(`It should upDate the present location`, done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Success");
        expect(response.message).to.equal(
          "Present location successfully updated"
        );
        done();
      });
  });
  ...
  it("It should not update the status of an order if new status is not provided", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(res.statusCode).to.equal(400);
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal("Delivery status is required");
        done();
      });
  });
  ...
  it("It should not update the status of an order if new status is not provided", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Delivery status is not allowed to be empty"
        );
        done();
      });
  });
  ...
  it("It should not update the status of an order if new status is not provided", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Delivery status must be one of [Transiting, Delivered]"
        );
        done();
      });
  });
  ...
  it("It should not update the destination of a parcel if cancelled", done => {
    server
      ...
      .end((err, res) => {
        ...
        expect(response.status).to.equal("Fail");
        expect(response.message).to.equal(
          "Parcel already cancelled, destination cannot be updated"
        );
        done();
      });
  });
